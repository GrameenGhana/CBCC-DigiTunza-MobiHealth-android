...
public class MobiHealthDataClass {
	...
	public static final String GROUP_MEETINGS_CREATE_TABLE =
			"CREATE TABLE " + MobiHealthDatabase.GROUP_MEETINGS_TABLE + " (" +
					MobiHealthDatabase._ID + " INTEGER PRIMARY KEY," +
					MobiHealthDatabase.GROUP_MEETING_TOPIC + TEXT_TYPE + COMMA_SEP +
					MobiHealthDatabase.GROUP_MEETING_START_DATE_TIME + TEXT_TYPE + COMMA_SEP +
					MobiHealthDatabase.GROUP_MEETING_END_DATE_TIME + TEXT_TYPE + COMMA_SEP +
 					MobiHealthDatabase.GROUP_MEETING_LOCATION + TEXT_TYPE +
					" )";



	public static final String GROUP_MEETING_ATTENDEES_CREATE_TABLE =
			"CREATE TABLE " + MobiHealthDatabase.GROUP_MEETING_ATTENDEES_TABLE + " (" +
					MobiHealthDatabase._ID + " INTEGER PRIMARY KEY," +
					MobiHealthDatabase.GROUP_MEETING_ATTENDEE_NAME + TEXT_TYPE + COMMA_SEP +
  					MobiHealthDatabase.GROUP_MEETING_UID + TEXT_TYPE +
					" )";


	public static final String ALL_SUB_SECTION_NAMES_CREATE_TABLE =
			"CREATE TABLE " + MobiHealthDatabase.ALL_SUBSECTION_NAMES_TABLE + " (" +
					MobiHealthDatabase._ID + " INTEGER PRIMARY KEY," +
					MobiHealthDatabase.SUBSECTION_ACTIVITY_NAME + TEXT_TYPE + COMMA_SEP +
					MobiHealthDatabase.SUBSECTION_NAME + TEXT_TYPE +
					" )";
...
//	table create statement for login activity table
	...
	public static final String GROUP_MEETING_DELETE_TABLE =
			"DROP TABLE IF EXISTS " + MobiHealthDatabase.GROUP_MEETINGS_TABLE;


	public static final String GROUP_MEETINGS_ATTENDEES_DELETE_TABLE =
			"DROP TABLE IF EXISTS " + MobiHealthDatabase.GROUP_MEETING_ATTENDEES_TABLE;

	public static final String ALL_SUBSECTION_NAMES_DELETE_TABLE =
			"DROP TABLE IF EXISTS " + MobiHealthDatabase.ALL_SUBSECTION_NAMES_TABLE;
