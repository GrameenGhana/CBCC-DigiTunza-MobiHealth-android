...
public class AlertMessagesActivity extends BaseActivity implements OnClickListener{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		chps_zone = sharedPref.getString("chps_zone", "ASIDOWUI CHPS");
		community = sharedPref.getString("community", "Akporkplorto");
		fullname = sharedPref.getString("fullname", "name");
		type="SMS";
